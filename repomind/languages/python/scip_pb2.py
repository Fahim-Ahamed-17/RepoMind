# Vendored, not hand-written. RM-022: repomind/languages/python/scip.proto is
# sourcegraph/scip's published schema (Apache-2.0, github.com/sourcegraph/scip,
# fetched 2026-09-10), compiled with `python -m grpc_tools.protoc` from
# grpcio-tools==1.64.0 -- chosen specifically because that version's bundled
# protoc emits gencode pinned to protobuf>=5.26.1,<6, matching this project's
# own `protobuf>=5.26,<7` constraint (pyproject.toml); a newer grpcio-tools
# emits gencode requiring a newer protobuf runtime than we depend on and
# fails at import time. `grpcio-tools` itself is never a runtime or dev
# dependency -- it was installed ephemerally, once, only to run protoc.
#
# To regenerate after a schema update:
#   pip install grpcio-tools==1.64.0
#   python -m grpc_tools.protoc -I repomind/languages/python \
#       --python_out=repomind/languages/python \
#       --pyi_out=repomind/languages/python \
#       repomind/languages/python/scip.proto
#   pip uninstall grpcio-tools grpcio
#
# -*- coding: utf-8 -*-
